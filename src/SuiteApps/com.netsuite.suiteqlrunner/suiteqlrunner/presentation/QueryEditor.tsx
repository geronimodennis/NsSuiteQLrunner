...
export function QueryEditor(props: QueryEditorProps) {
  ...
  editorItems.push(
    <StackPanel.Item key={'autocomplete'}>
  ...
  return (
    <Portlet title={'Query Editor'} icon={SystemIcon.EDIT}>
      <StackPanel.Vertical itemGap={StackPanel.GapSize.MEDIUM}>{editorItems}</StackPanel.Vertical>
    </Portlet>
  );
}
