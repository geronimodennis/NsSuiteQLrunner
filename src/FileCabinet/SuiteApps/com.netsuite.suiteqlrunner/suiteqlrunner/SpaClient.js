...
ORDER BY
    ...
    class SuiteQLRunner extends core.PureComponent {
        ...
        renderLayoutItems() {
            const items = [
                jsxRuntime.jsx(component.StackPanel.Item, { shrink: 0, children: jsxRuntime.jsx(component.ApplicationHeader, { icon: core.SystemIcon.SEARCH, title: 'SuiteQL Runner', subtitle: 'Format, inspect, execute, and measure SuiteQL', actions: [
                            {
                                label: 'Run SuiteQL',
